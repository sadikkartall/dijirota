...
<head>
    ...
    <link rel="icon" href="<?= e(APP_URL) ?>/assets/images/favicon.svg?v=20260913" type="image/svg+xml">
    <link rel="stylesheet" href="<?= e(APP_URL) ?>/assets/css/app.css?v=20260913-type">
    <?php if (!empty($structured_data)) { render_json_ld($structured_data); } ?>
</head>
<body>
<header class="site-header">
    <div class="container nav-wrap">
        <a class="brand" href="<?= e(APP_URL) ?>/"><img class="brand-logo" src="<?= e(APP_URL) ?>/assets/images/logo.svg?v=20260913" alt="Dijirota — ana sayfa" width="263" height="76"></a>
