...
function dijirota_legal_pages(): array
{
    return [
        'gizlilik-politikasi' => [
            ...
            'sections' => [
                ['title' => '1. Veri sorumlusu', 'paragraphs' => ['DİJİROTA markası altında sunulan hizmetler kapsamında işlenen kişisel verilerden hizmet sağlayıcı olarak DİJİROTA sorumludur.'], 'items' => ['E-posta: info@dijirota.com', 'Telefon / WhatsApp: +90 544 620 16 21', 'Faaliyet bölgesi: Türkiye']],
        ...
        'kullanim-kosullari' => [
            ...
            'sections' => [
                ['title' => '1. Hizmet sağlayıcı', 'paragraphs' => ['DİJİROTA; sektörlere özel kurumsal web sayfaları, domain, hosting, temel kurulum ve yönetim paneli hizmetleri sunan bir dijital hizmet markasıdır.'], 'items' => ['E-posta: info@dijirota.com', 'Telefon / WhatsApp: +90 544 620 16 21']],
        ...
        'mesafeli-satis-sozlesmesi' => [
            ...
            'sections' => [
                ['title' => '1. Taraflar', 'paragraphs' => ['Hizmet sağlayıcı DİJİROTA ile web sitesi üzerinden sipariş veren gerçek veya tüzel kişi bu sözleşmenin taraflarıdır. Sipariş sırasında girilen bilgiler sözleşme ve iletişim süreçlerinde esas alınır.'], 'items' => ['Hizmet sağlayıcı: DİJİROTA', 'E-posta: info@dijirota.com', 'Telefon: +90 544 620 16 21']],
                ...
                ['title' => '6. Cayma, iptal ve iade', 'paragraphs' => ['Dijital hizmetin ifasına, domain tesciline veya kurulum çalışmalarına başlanması halinde cayma ve iade koşulları yürürlükteki tüketici mevzuatı ile sipariş sırasında sunulan bilgilendirmeler çerçevesinde değerlendirilir. İptal veya iade talebinizi info@dijirota.com adresine sipariş numaranızla birlikte iletebilirsiniz.'], 'items' => ['Teknik sebeple hizmetin sunulamaması halinde talep ayrıca incelenir', 'Onaylanan iadeler ödeme yöntemine uygun şekilde gerçekleştirilir', 'Her talep hizmetin hangi aşamada olduğu dikkate alınarak değerlendirilir']],
        ...
        'on-bilgilendirme-formu' => [
            ...
            'sections' => [
                ['title' => '1. Hizmet sağlayıcı bilgileri', 'paragraphs' => ['Sipariş ve kurulum süreçlerinde hizmet sağlayıcı DİJİROTA’dır.'], 'items' => ['Marka: DİJİROTA', 'E-posta: info@dijirota.com', 'Telefon / WhatsApp: +90 544 620 16 21', 'Faaliyet bölgesi: Türkiye']],
                ...
                ['title' => '6. Cayma ve iade hakkında', 'paragraphs' => ['Dijital hizmet, domain ve kurulum işlemleri için cayma ve iade koşulları yürürlükteki mevzuata ve Mesafeli Satış Sözleşmesi’ne göre uygulanır. Sorularınız veya talepleriniz için ödeme öncesinde info@dijirota.com adresinden bilgi alabilirsiniz.'], 'items' => []],
                ['title' => '7. Şikâyet ve başvurular', 'paragraphs' => ['Sipariş, ödeme veya kurulumla ilgili talep ve şikâyetlerinizi sipariş numaranızla birlikte info@dijirota.com adresine veya +90 544 620 16 21 WhatsApp hattına iletebilirsiniz.'], 'items' => []],
            ],
        ],
    ];
}
